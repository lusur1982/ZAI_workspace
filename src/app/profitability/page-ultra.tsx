...
const variants: VariantConfig[] = [
  {
    id: 'ultra',
    name: 'Ultra Rýchla',
    description: 'Okamžité načítanie, predpočítané hodnoty',
    speed: '~0.1s',
...
// Comprehensive static profitability data for ultra-fast variant
const staticProfitabilityData: ProfitabilityData[] = [
  ...
  },
  {
    ...
    price: 3299,
    description: "Next-generation Bitcoin miner with 140 TH/s",
    type: "ASIC",
    cooling: "Air Cooling",
    images: [],
    featured: true,
    ...
    createdAt: new Date().toISOString(),
    dailyRevenue: 15.75,
    monthlyRevenue: 472.50,
    yearlyRevenue: 5748.75,
    electricityCost: 252.00,
    netProfit: 220.50,
    roi: 80.2
  },
  {
    ...
    price: 2999,
    description: "Latest generation miner with 126 TH/s",
    type: "ASIC",
    cooling: "Air Cooling",
    images: [],
    featured: false,
    ...
    createdAt: new Date().toISOString(),
    dailyRevenue: 14.25,
    monthlyRevenue: 427.50,
    yearlyRevenue: 5211.25,
    electricityCost: 246.00,
    netProfit: 181.50,
    roi: 72.6
  },
  {
    ...
    slug: "jasminer-x4-1u",
    price: 1599,
    description: "Compact Ethereum miner with high efficiency",
    type: "ASIC",
    cooling: "Air Cooling",
    images: [],
    featured: false,
    ...
    createdAt: new Date().toISOString(),
    dailyRevenue: 8.50,
    monthlyRevenue: 255.00,
    yearlyRevenue: 3102.50,
    electricityCost: 144.00,
    netProfit: 111.00,
    roi: 83.3
  },
  {
    ...
    slug: "goldshell-kd6",
    price: 899,
    description: "Compact Kadena miner for home mining",
    type: "ASIC",
    cooling: "Air Cooling",
    images: [],
    featured: false,
    ...
    createdAt: new Date().toISOString(),
    dailyRevenue: 5.25,
    monthlyRevenue: 157.50,
    yearlyRevenue: 1916.25,
    electricityCost: 108.00,
    netProfit: 49.50,
    roi: 66.0
  },
  {
    ...
    slug: "antminer-t19",
    price: 1799,
    description: "Efficient Bitcoin miner with 84 TH/s",
    type: "ASIC",
    cooling: "Air Cooling",
    images: [],
    featured: false,
    ...
    yearlyRevenue: 3467.50,
    electricityCost: 180.00,
    netProfit: 105.00,
    roi: 70.0
  }
]

export default function ProfitabilityPageOptimized() {
  ...
  useEffect(() => {
    ...
    // Hybrid and Standard: fetch from API and calculate
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Compare mining profitability across different crypto miners
        </p>
      </div>
